      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm text-gray-800">
        <div className="space-y-3">
          <div className="flex justify-between">
            ...
            <span className="font-semibold">{item.lowStockItems || 0}</span>
          </div>
          <div className="flex justify-between">
            <span>Item Groups</span>
            <span className="font-semibold">{item.allItemGroups || 0}</span>
          </div>
          <div className="flex justify-between">
            <span>Total Items</span>
            <span className="font-semibold">{item.allItems || 0}</span>
          </div>
        </div>
