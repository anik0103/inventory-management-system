...
const Filters = ({ onFilterChange , onSortFilterChange}) => {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      onFilterChange({ productName, category, quantity, price, sortOrder });
    }, 300); // 300ms delay after typing

    return () => clearTimeout(timeout);
  }, [productName, category, quantity, price, sortOrder, onFilterChange]);
